  ...
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className='text-center'>
                <h2 className='flex justify-center items-center text-blue-700 text-5xl font-bold'>
                    <GiWhaleTail className='text-blue-900 mr-2' size={60} />
                    <span className='text-blue-400'>TELL</span>TRIPZY
                </h2>
            </div>

           
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-10 mb-5 border-b border-gray-200">
                    ...
                    <span className="text-lg text-gray-500 text-center block">©<a href="https://pagedone.io/">Mayur Pimpude</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
